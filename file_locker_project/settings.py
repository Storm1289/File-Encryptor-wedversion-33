"""
Django settings for file_locker_project project.
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-(+b=e67@$hpovp5(9_sk$f^b4ft#^i&27gu#j_o=n_060v$fe@')
...
MIDDLEWARE = [
    ...
    'locker_app.middleware.ServerlessSessionMiddleware',
...
ROOT_URLCONF = 'file_locker_project.urls'
...
WSGI_APPLICATION = 'file_locker_project.wsgi.application'
